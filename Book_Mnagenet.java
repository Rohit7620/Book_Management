...
public class Book_Mnagenet 
{
	String url="jdbc:mysql://localhost:3306/book_management";// Datatbase Mysql Server Path
	...
	{
		System.out.println("Welcome to Rohit Book Store");
		Book_Mnagenet bm = new Book_Mnagenet();// create object of Book_Mnagenet.
		bm.my_operations();// call function to perform operation using class object

	}
	public void my_operations()
	{
		Book_operation bo = new Book_operation();// Create Book class bject to perform book Operation
		Author_operation ao = new Author_operation();//Create Author class bject to perform Author Operation 
			...
			try
			{
					...
					do
					{
							...
							{
							case 1:
								bo.add_book(conn);// call add book function from Book_Operation for added book data. 
								break;
								
							case 2:
								bo.edit_book(conn);// call edit book function from Book_Operation for edit book data.
								break;
								
							case 3:
								bo.delete_book(conn);// call delete book function from Book_Operation for delete book data.
								break;
							case 4:
								
								bo.get_book_byId(conn);// call get book data function from Book_Operation for retrive book data by using by id.
								break;
								
							case 5:
								bo.all_books_details(conn);// call all book details function from Book_Operation for Display all book data.
								break;
								
							case 6:
								ao.add_Author(conn);// call add author function from Author_Operation for added Author data.
								break;
								
							case 7:
								ao.edit_Author(conn);// call edit author function from Author_Operation for edit Author data.		
								break;
								
							case 8:
								ao.author_delete(conn);// call delete author function from Author_Operation for delete Author data.
								break;
								
							case 9:
								ao.get_author_byId(conn);// call get author data function from Author_Operation for retrive author data by using author id.
								break;
								
							case 10:
								ao.all_author_details(conn);// call all author details function from Author_Operation for Display all Author data.
								break;
								
							case 11:
								bo.assign_author(conn);// call assign author function to assign author_id to book_details table
								break;
