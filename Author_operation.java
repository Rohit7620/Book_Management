...
public class Author_operation extends Book_Mnagenet// extend the functionality of Book_Mnagenet class to Author_operation class
{
	...
	public void add_Author(Connection conn) throws Exception // function to add Author details using throws exception passing the Connection conn object for connect with the database.
	{
		...
		do
		{
			...
			PreparedStatement ps = conn.prepareStatement("insert into author_details (author_id,author_name,author_email,author_phone) value(?,?,?,?)");// insert sql query for insert data into the  Author_details table. and  execute the sql statement using prepared statement.
	...
	public void get_author_byId(Connection conn) throws Exception// function to get Author details by using Author_id using throws exception passing the Connection conn object for connect with the database.
	{
		...
		do
		{
			...
			PreparedStatement ps = conn.prepareStatement("select *from author_details where author_id=?");// sql query for retrive data from table. and create sql statement using preparedstatement.
	...
	{
		Author_operation ao = new Author_operation();
	}
