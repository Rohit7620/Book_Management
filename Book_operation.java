...
public class Book_operation extends Book_Mnagenet // extend the functionality of Book_Mnagenet class to Book_operation class
{
	...
	public void add_book(Connection conn) throws Exception // function to add book details using throws exception passing the Connection conn object for connect with the database.
	{
		...
		do
		{
			...
			PreparedStatement ps = conn.prepareStatement("insert into book_details (book_id,book_name,book_price,book_qunt) value(?,?,?,?)");// execute the insert sql query for insert data into the  book_details table. sql statement using prepared statement.
	...
	public void get_book_byId(Connection conn) throws Exception // function to get book details by using book_id using throws exception passing the Connection conn object for connect with the database.
	{
		...
		do
		{
			...
			PreparedStatement ps = conn.prepareStatement("select *from book_details where book_id=?");// sql query for retrive data from table and create sql statement using preparedstatement.
			System.out.println("Enter Book Id : ");
	...
	public void assign_author(Connection conn) throws Exception// function to assign author to a book using throws exception passing the Connection conn object for connect with the database.
	{
		...
		{ 
			...
			PreparedStatement ps = conn.prepareStatement("update book_details set author_id=? where book_id=? ");// create sql statement for update and set the author id to book id. and execute sql statement.
	...
	{
		Book_operation bo = new Book_operation();
	}
